...
<html>
    <head>
        ...
        <title>Crear Medellin</title>
    </head>
    <body class="fondo">
        <div class ="container mt-5">
            <div class="row">
                <div class="col">
                    <h3 class="display-5 text-center">Agregar lugar a Medellín</h3>
                    <form action="crearmede.jsp" method="post">
                        <div class="mb-3">
        ...
        <%
            if(request.getParameter("enviar")!=null){
                ...
                try {
                     ...
                     st.executeUpdate("insert into medellin (nombre,clima,distancia) values('"+nombre+"','"+clima+"','"+distancia+"');");
                     request.getRequestDispatcher("medellin.jsp").forward(request, response);
                    } catch (Exception e) {
                    out.print(e);
                    }
            }
