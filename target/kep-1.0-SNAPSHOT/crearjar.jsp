...
<html>
    <head>
        ...
        <title>Crear Jardín</title>
    </head>
    <body class="fondo">
        <div class ="container mt-5">
            <div class="row">
                <div class="col">
                    <h3 class="display-5 text-center">Agregar lugar a Jardín</h3>
                    <form action="crearjar.jsp" method="post">
                        <div class="mb-3">
        ...
        <%
            if(request.getParameter("enviar")!=null){
                ...
                try {
                     ...
                     st.executeUpdate("insert into jardin (nombre,clima,distancia) values('"+nombre+"','"+clima+"','"+distancia+"');");
                     request.getRequestDispatcher("jardin.jsp").forward(request, response);
                    } catch (Exception e) {
                    out.print(e);
                    }
            }
