...
<body>
    ...
    <div class ="container mt-5">
        <div class="row">
            <div class="col">
                <h1 class="display-4 text-center">Bienvenido a los sitios turísticos de Santa Fé</h1>
                <table class="table">
                    <thead>
                        <tr>
                            <th scope="col" colspan="4"><h3>Sitios Santa Fé</h3></th>
                            <th scope="col">
                                <a class="btn-default btn-sm bg-info text-black" href="crearsantafe.jsp"> Agregar Lugar </a>
                            </th>
                        </tr>
                        <tr>
                            <th scope="col">ID</th>
        ...
        <div class="container">
            <div class="row">
                <div class="card col-sm-4">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">Cabalgata</h4>
                        <a href="cabalgata.jsp" class="btn btn-primary">Info</a>
                    </div>
                </div>
                <div class="card col-sm-4" >             
                    <div class="card-body">
                        <h4 class="card-title">Ruta del Café</h4>
                        <a href="cafe.jsp" class="btn btn-primary">Info</a>
                    </div>
                </div>
                <div class="card col-sm-4">
                    <div class="card-body">
                        <h4 class="card-title">Centro Histórico</h4>
                        <a href="historico.jsp" class="btn btn-primary">Info</a>
                    </div>
                </div>
            </div>
        </div>
