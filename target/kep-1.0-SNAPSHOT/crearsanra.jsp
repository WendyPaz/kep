...
<html>
    <head>
        ...
        <title>Crear San Rafael</title>
    </head>
    <body class="fondo">
        <div class ="container mt-5">
            <div class="row">
                <div class="col">
                    <h3 class="display-5 text-center">Agregar lugar a San Rafael</h3>
                    <form action="crearsanra.jsp" method="post">
                        <div class="mb-3">
        ...
        <%
            if(request.getParameter("enviar")!=null){
                ...
                try {
                     ...
                     st.executeUpdate("insert into `san rafael` (nombre,clima,distancia) values('"+nombre+"','"+clima+"','"+distancia+"');");
                     request.getRequestDispatcher("sanrafael.jsp").forward(request, response);
                    } catch (Exception e) {
                    out.print(e);
                    }
            }
