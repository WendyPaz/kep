...
<html>
    <head>
        ...
        <title>Mirador de Peñas Blancas</title>
    </head>
    <header>
...
<body>
    <div class="container mt-5">
        <div class="row">
            <div class="col">
                <div class="jumbotron " >
                    <h1 class="display-4 text-center">Mirador de Peñas Blancas!</h1>
                    <p class="text-center"><img class="center" src="peñas1.jpg" width="450px" height="280px" ></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <ul class="text-center list-unstyled">
                <li>Fuente de los chuscos  (Esculturas de madera, Avistamiento de cabras Montesas)</li>
                <li>Senderismo   (Caminatas, senderismo con perros, avistamiento de aves)</li>
            </ul>
            <hr>
            <br>
            <p class="text-center"><img class="center" src="peñas2.jpg" width="450px" height="280px" ></p>
            <br>
            <p class="lead text-center">Si quieres información más detallada de este sitio da click en el siguiente botón.</p>
            <br>
            <p class="text-center"><a target="_blank" href="https://www.conmiperro.es/index.php/ocio/item/539-ruta-mirador-de-penas-blancas-villagordo-del-cabriel" class="btn btn-info">Más</a></p>
        </div>
    </div>
    <br>
    <br>
