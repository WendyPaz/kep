...
<html>
    ...
    <body>
        ...
        <div class ="container mt-5">
            <div class="row">
                <div class="col">
                    <h1 class="display-4 text-center">Bienvenido a los sitios turísticos de San Rafael</h1>
                    <table class="table">
                        <thead>
                            <tr>
                                <th scope="col" colspan="4"><h3>Sitios San Rafael</h3></th>
                                 <th scope="col">
                                     <a class="btn-default btn-sm bg-info text-black" href="crearsanra.jsp"> Agregar Lugar </a>
                                </th>
                            </tr>
                            <tr>
                                <th scope="col">ID</th>
                        ...
                        <tbody>
                            <%
                                ...
                                rs = st.executeQuery("SELECT * FROM `san rafael`;");
                                while (rs.next()){
                            %>
                            <tr>
        ...
        <div class="container">
            <div class="row">
                <div class="card col-sm-4">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">Bycicle Adventure</h4>
                        <a href="adventure.jsp" class="btn btn-primary">Info</a>
                    </div>
                </div>
                <div class="card col-sm-4" >             
                    <div class="card-body">
                        <h4 class="card-title">Experience, Conéctate con la naturaleza</h4>
                        <a href="experience.jsp" class="btn btn-primary">Info</a>
                    </div>
                </div>
                <div class="card col-sm-4">
                    <div class="card-body">
                        <h4 class="card-title">Tour San Rafael</h4>
                        <a href="rafael.jsp" class="btn btn-primary">Info</a>
                    </div>
                </div>
            </div>
        </div>    
