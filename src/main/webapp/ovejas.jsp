...
<html>
    <head>
        ...
        <title>Caminata Llano de Ovejas</title>
    </head>
    <header>
...
<body>
    <div class="container mt-5">
        <div class="row">
            <div class="col">
                <div class="jumbotron " >
                    <h1 class="display-4 text-center">Caminata Llano de Ovejas!</h1>
                    <p class="text-center"><img class="center" src="ov1.jpeg" width="450px" height="280px" ></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <ul class="text-center list-unstyled">
                <li>Caserío la Unión</li>
                <li>Hatos Lecheros</li>
                <li>Ovejas</li> 
                <li>Neblina y Cebolla</li> 
                <li>Yegua Albina y Barro Colorado</li> 
            </ul>
            <hr>
            <br>
            <p class="text-center"><img class="center" src="ov2.jpeg" width="450px" height="280px" ></p>
            <br>
            <p class="lead text-center">Si quieres información más detallada de este sitio da click en el siguiente botón.</p>
            <br>
            <p class="text-center"><a target="_blank" href="http://caminantestodoterreno.blogspot.com/2009/06/caminata-la-union-ovejas-san-jeronimo.html" class="btn btn-info">Más</a></p>
        </div>
    </div>
    <br>
    <br>
