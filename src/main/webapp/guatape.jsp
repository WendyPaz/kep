...
<html>
    ...
    <body>
        ...
        <div class ="container mt-5">
            <div class="row">
                <div class="col">
                    <h1 class="display-4 text-center">Bienvenido a los sitios turísticos de Guatapé</h1>
                    <table class="table">
                        <thead>
                            <tr>
                                <th scope="col" colspan="4"><h3>Sitios Guatapé</h3></th>
                                 <th scope="col">
                                     <a class="btn-default btn-sm bg-info text-black" href="creargua.jsp"> Agregar Lugar </a>
                                </th>
                            </tr>
                            <tr>
                                <th scope="col">ID</th>
                        ...
                        <tbody>
                            <%
                                ...
                                rs = st.executeQuery("SELECT * FROM `guatape`;");
                                while (rs.next()){
                            %>
                            <tr>
...
<p class="leader">*Todos los lugares que aparecen en la lista, pero que no tienen acceso en los botones son sugerencias del usuario y están pendientes de revisión*</p>
        ...
        <div class="card col-sm-4">
            ...
            <div class="card-body">
              <h4 class="card-title">Embalse el Peñol</h4>
              <a href="embalse.jsp" class="btn btn-primary">Info</a>
            </div>
          </div>
          <div class="card col-sm-4" >             
            <div class="card-body">
              <h4 class="card-title">Cascada el Cristalino</h4>
              <a href="cascada.jsp" class="btn btn-primary">Info</a>
            </div>
          </div>
          <div class="card col-sm-4">
            <div class="card-body">
              <h4 class="card-title">Plazoleta de los Zócalos</h4>
              <a href="plazoleta.jsp" class="btn btn-primary">Info</a>
            </div>
          </div>
        </div>
    </div>          
