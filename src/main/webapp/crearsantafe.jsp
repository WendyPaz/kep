...
<html>
    <head>
        ...
        <title>Crear Santa Fé</title>
    </head>
    <body class="fondo">
        <div class ="container mt-5">
            <div class="row">
                <div class="col">
                    <h3 class="display-5 text-center">Agregar lugar a Santa Fé</h3>
                    <form action="crearsantafe.jsp" method="post">
                        <div class="mb-3">
        ...
        <%
            if(request.getParameter("enviar")!=null){
                ...
                try {
                     ...
                     st.executeUpdate("insert into santafe (nombre,clima,distancia) values('"+nombre+"','"+clima+"','"+distancia+"');");
                     request.getRequestDispatcher("santafe.jsp").forward(request, response);
                    } catch (Exception e) {
                    out.print(e);
                    }
            }
