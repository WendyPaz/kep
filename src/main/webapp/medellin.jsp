...
<body>
    ...
    <div class ="container mt-5">
        <div class="row">
            <div class="col">
                <h1 class="display-4 text-center">Bienvenido a los sitios turísticos de Medellín</h1>
                <table class="table">
                    <thead>
                        <tr>
                            <th scope="col" colspan="4"><h3>Sitios Medellín</h3></th>
                            <th scope="col">
                                <a class="btn-default btn-sm bg-info text-black" href="crearmede.jsp"> Agregar Lugar </a>
                            </th>
                        </tr>
                        <tr>
                            <th scope="col">ID</th>
                    ...
                    <tbody>
                        <%
                            try {
                                ...
                                rs = st.executeQuery("SELECT * FROM `medellin`;");
                                while (rs.next()) {
                        %>
                        <tr>
        ...
        <div class="container">
            <div class="row">
                <div class="card col-sm-4">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">Parque Arví </h4>
                        <a href="arvi.jsp" class="btn btn-primary">Info</a>
                    </div>
                </div>
                <div class="card col-sm-4" >             
                    <div class="card-body">
                        <h4 class="card-title">Tour Cultivo de Flores</h4>
                        <a href="flores.jsp" class="btn btn-primary">Info</a>
                    </div>
                </div>
                <div class="card col-sm-4">
                    <div class="card-body">
                        <h4 class="card-title">Un día en Bicicleta</h4>
                        <a href="bicicleta.jsp" class="btn btn-primary">Info</a>
                    </div>
                </div>
