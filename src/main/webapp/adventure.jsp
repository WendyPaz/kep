...
<body>
    <div class="container mt-5">
        <div class="row">
            <div class="col">
                <div class="jumbotron " >
                    <h1 class="display-4 text-center">Bycicle Adventure!</h1>
                    <p class="text-center"><img class="center" src="ba1.jpg" width="450px" height="280px" ></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <p class="h5">Un plan Perfecto para conocer San Rafael<br>
Hay rutas muy buenas y la bicis perfectas para los recorridos al río. La atención del equipo de Bicycle adventure excelente y siempre están dispuestos a ayudarte y darte indicaciones.</p>
            <br>
            <br>
            <hr>
            ...
            <hr>
            <br>
            <p class="text-center"><img class="center" src="ba2.jpeg" width="450px" height="280px" ></p>
            <br>
            <p class="lead text-center">Si quieres información más detallada de este sitio da click en el siguiente botón.</p>
            <br>
            <p class="text-center"><a href="https://www.tripadvisor.es/Attraction_Review-g12107000-d21352046-Reviews-Bicycle_Adventure_San_Rafael-San_Rafael_Antioquia_Department.html" class="btn btn-info">Más</a></p>
        </div>
    </div>
    <br>
    <br>
